...
public partial class Form1 : Form
{
    ...
    private TextBox CreateNewTextBox(string text = "")
    {
        var textBox = new TextBox
        {
            ...
            Dock = DockStyle.Fill,
            Height = 25,
            Font = new Font("¸¼Àº °íµñ", 10.0f),
            ImeMode = ImeMode.Hangul,
            Text = text,
        };
        AdjustTextBoxSize(textBox);

        textBox.TextChanged += OnAdjustTextBoxSize;
    ...
    private void Form1_Load(object sender, EventArgs e)
    {
        ...
        Location = new Point(Screen.PrimaryScreen.Bounds.Width - Size.Width,
            (int)(Screen.PrimaryScreen.Bounds.Height * 0.2));
        ...
        else
        {
                         ...
                         StringSplitOptions.RemoveEmptyEntries))
            {
                ...
                _lay.Controls.Add(textBox, 0, _lay.RowCount);
                _lay.RowCount += 1;
                OnAdjustTextBoxSize(textBox, null);
            }
    ...
    private void Item_KeyDown(object sender, KeyEventArgs e)
    {
        ...
        switch (e.KeyCode)
        {
            ...
            case Keys.Down:
            {
                ...
                else if (textBox.GetLineFromCharIndex(textBox.SelectionStart) >=
                         textBox.GetLineFromCharIndex(textBox.Text.Length - 1)
    ...
    private void OnAdjustTextBoxSize(object sender, EventArgs e)
    {
        var textBox = (TextBox)sender;
        AdjustTextBoxSize(textBox);
    }

    private void AdjustTextBoxSize(TextBox textBox)
    {
